...
export default function Navbar() {
  ...
  return (
    <div className="px-4 py-4 relative z-50">
      {/* Main Nav */}
      <nav className="bg-white border border-zinc-200 rounded-xl px-6 flex items-center justify-between h-15 relative">
        {/* Logo */}
        <Link href="/" className="flex items-center gap-2.5 no-underline z-10">
          <LogoIcon />
          <span
            className="text-[18px] font-bold tracking-tight text-zinc-900"
        ...
        <div className="hidden md:flex items-center gap-2.5 z-10">
          <button className="text-sm font-medium text-zinc-500 bg-transparent border border-zinc-200 rounded-lg px-3.5 py-1.5 cursor-pointer hover:bg-zinc-100 transition-colors">
            Log in
          </button>
          ...
          <div className="w-7.5 h-7.5 rounded-full bg-[#e1f5ee] flex items-center justify-center text-xs font-semibold text-[#0f6e56] border border-zinc-200 cursor-pointer shrink-0">
            AK
          </div>
        </div>
        ...
        <button
          className="md:hidden flex items-center justify-center w-9 h-9 bg-transparent border border-zinc-200 rounded-lg cursor-pointer text-zinc-700 z-10"
        ...
        {/* Mobile Dropdown */}
        <div
          className={`md:hidden absolute top-17 left-0 right-0 bg-white border border-zinc-200 rounded-xl p-3 z-50 transition-all duration-200
        ...
        >
          ...
          <div className="flex gap-2 pt-1">
            <button className="flex-1 text-sm font-medium text-zinc-500 bg-transparent border border-zinc-200 rounded-lg py-2 cursor-pointer hover:bg-zinc-100 transition-colors">
              Log in
            </button>
